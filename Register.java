...
// Final print
		...
		{
			System.out.println("Your details are not found in Register");
		}
...
//Get uername and validate
System.out.println("Enter your username");
String usr = sc.next();
r1.validateusername(usr);	
...
//String pwd1 = sc.next();
//need to write a program for validating the stored variables
/*			if (n1=r1.n)
	{
